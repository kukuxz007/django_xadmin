...
TOOLBARS_SETTINGS = {
    ...
    "mini": [['source','|','insertimage','|','insertvideo','|','preview']],
...
UEditorUploadSettings = {
    ...
    "imageUrlPrefix": "",
    "imagePathFormat": "",
    "imageAllowFiles": [".png", ".jpg", ".jpeg", ".gif", ".bmp",".svg"],  # 上传图片格式显示
    ...
    "fileAllowFiles": [
        ...
        ".doc", ".docx", ".xls", ".xlsx", ".ppt", ".pptx", ".pdf", ".txt", ".md", ".xml",".svg"
    ],  # 上传文件格式显示 */
    ...
    # 列出的文件类型 */
    "imageManagerAllowFiles": [".png", ".jpg", ".jpeg", ".gif", ".bmp",".svg"],
